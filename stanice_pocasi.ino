...
// WiFi připojení
const char* ssid = "Tvoje wifi";
const char* password = "heslo";

// OpenWeatherMap API
const char* host = "api.openweathermap.org";
const char* city = "tvoje město...";
const char* country = "cz";
const char* apiKey = "tvuj api kod";
...
void setup() {
  ...
  // Inicializace I2C (prohozené piny)
...
void updateWeather() {
  ...
  // nové hodnoty: rychlost větru a tlak
  float windSpeed = doc["wind"]["speed"] | 0.0;
  int pressure = doc["main"]["pressure"] | 0;

  // nastavíme currentWeather na info o větru a tlaku pro třetí řádek
  currentWeather = "Vitr:" + String(windSpeed, 1) + "m/s";
}
