...
SoftwareSerial Bluetooth(3, 2); // RX, TX pro komunikaci přes Bluetooth
Adafruit_PWMServoDriver pwm = Adafruit_PWMServoDriver(); // Inicializace 16-kanálového PWM-Servo Shieldu
...
int servo5 = 7;  // loket
int servo7 = 8;  // chytač (gripper) 

// Nastavení rychlostí serv
int s1Vel = 25; // ZÁKLADNA    
int s2Vel = 25; // RAMENO
int s3Vel = 25; // RAMENO
int s4Vel = 25; // LOKET1
int s5Vel = 25; // LOKET2
...
int s1[80], s2[80], s3[80], s4[80], s5[80], s7[80]; // Pole pro ukládání pozic
...
void ulozenipozice() {
  if (jeNahravani && ulozenyIndex < 80) {
